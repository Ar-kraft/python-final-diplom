...
1. [Спецификация (API) - 1 шт.](referencecreens.md)
...
Базовая часть:
1. [Создание и настройка проекта](referencetep-1.md)
2. [Проработка моделей данных](referencetep-2.md)
3. [Реализация импорта товаров](referencetep-3.md)
4. [Реализация API views](referencetep-4.md)
5. [Полностью готовый backend](referencetep-5.md)

Продвинутая часть (по желанию, если базовая часть полностью готова):

6. [Реализация forms и views админки склада](referencetep-6-adv.md)
7. [Вынос медленных методов в задачи Celery](referencetep-7-adv.md)
...
[перейдите по ссылке](referencetep-1.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](referencetep-2.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](referencetep-3.md).

### Этап 4. Реализация forms и views

Критерии достижения:

1. Реализованы API Views для основных [страниц](referencecreens.md) сервиса (без админки):
   - Вход
   - Регистрация
   - Список товаров
   - Карточка товара
...
Для получения подробностей по данному этапу
[перейдите по ссылке](referencetep-4.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](referencetep-5.md).

## Полезные материалы

1. [Информация о сервисе](referenceervice.md)
2. [Спецификация API](referencepi.md)
3. [Описание страниц сервиса](referencecreens.md)
...
1. Реализованы API views для [страниц админки](referencecreens.md) сервиса.
